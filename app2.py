...
VIDEO_PATH = r"path/to/your/local/video.mp4"  # Replace with your local video file path
...
with col1:
    ...
    distance = st.number_input("Estimated Flight Distance (miles)", min_value=1, value=500)
